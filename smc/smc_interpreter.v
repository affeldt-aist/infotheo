...
(* Again r2 indep of any other random variable
  because it is generated by the commodity server, not from any other random variables *)
Hypothesis x2s2x1'_r2_indep :
  P |= [% x2, s2, x1'] _|_ r2 .
