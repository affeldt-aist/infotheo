...
have @q : prob.
  ...
  by rewrite addR0 !fdistI_permE addRCA addRA -[X in (X <= _)%coqR]addR0 leR_add2l.
...
pose q' := (d ord0 / (1 - d (lift ord0 ord0)))%coqR.
move=> [:Hq].
have @q : prob.
  apply: (@Prob.mk_ q').
  abstract: Hq.
