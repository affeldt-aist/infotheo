...
Proof.
rewrite convC_set /= (_ : widen_itv _ = 1%:i01) ?conv1_set //.
...
Proof. by apply/set0P; exists 0%:i01. Qed.
...
Proof. apply/set0P; eexists; exists 1%:i01 => //; by rewrite conv1_set. Qed.
...
move=> {X} {Y} X Y u [] p _.
rewrite convC_set.
rewrite (_ : widen_itv _ = p%:num.~%:i01)// => H.
by exists p%:num.~%:i01 => //=.
Qed.
