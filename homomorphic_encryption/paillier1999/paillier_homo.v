...
(*                                                                            *)
(* Paillier encryption has the form                                            *)
(*                                                                            *)
(*   E(m;r) = g^m · r^n  (mod n^2)                                             *)
(*                                                                            *)
(* with g^n = 1. Multiplying ciphertexts adds exponents and multiplies masks:  *)
(*                                                                            *)
(*   E(m1;r1)·E(m2;r2) = g^{m1+m2}·(r1r2)^n = E(m1+m2; r1r2).                  *)
(*                                                                            *)
(* Exponentiating a ciphertext scales the plaintext (repeated addition):       *)
(*                                                                            *)
(*   E(m;r)^k = g^{m·k}·(r^k)^n = E(m *+ k; r^k).                              *)
(*                                                                            *)
(* This file packages those identities as theorems, by reusing the core       *)
(* lemmas from paillier_enc.v.                                                 *)
(*                                                                            *)
(******************************************************************************)
