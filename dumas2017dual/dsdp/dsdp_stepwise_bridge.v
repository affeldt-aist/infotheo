(******************************************************************************)
(*                                                                            *)
(*   DSDP Stepwise Bridge — Raw proc branch                                   *)
(*                                                                            *)
...
(*                                                                            *)
(*   Status: all lemmas (R-L1..R-L8, R-M1..R-M5, R-TH1) are Qed'd.            *)
(*   Headline theorem:                                                        *)
(*     dsdp_raw_translate_eq : translate_raw dsdp_raw_procs = dsdp_n_program  *)
(*   N-generic, no n_relay restriction.                                       *)
(*                                                                            *)
(******************************************************************************)
