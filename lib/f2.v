...
Proof.
by case/F2P : x y; case/F2P => //=; by rewrite ?(addr0,add0r,addrr_pchar2).
Qed.
...
Proof.
by rewrite /F2_of_bool; case; case => //=; rewrite ?(addr0,add0r,addrr_pchar2).
Qed.
...
Proof. apply/matrixP => i j; by rewrite !mxE addrr_pchar2. Qed.

Lemma F2_mx_opp m n (a : 'M['F_2]_(m, n)) : - a = a.
Proof. apply/matrixP => i j; by rewrite mxE oppr_pchar2. Qed.
...
Proof. apply/polyP => i; by rewrite coef0 coef_add_poly addrr_pchar2. Qed.
