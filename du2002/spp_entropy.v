...
field.
(* Workaround: `field` may produce one conjunctive goal or two separate goals
   depending on the Coq version. *)
...
(* Future work: addition lemma; actually we didn't use anything about mul above
  (any binop works) *)
...
(* Future work: deduce other indeps from this one. *)
...
(* Future work: Using graphoid for combinations of independent random variables. *)
