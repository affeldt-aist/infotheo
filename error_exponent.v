...
- rewrite 2!OutDist.dE /Rminus (big_morph _ morph_Ropp oppR0) -big_split /=.
  ...
  + rewrite /var_dist /=.
    apply (@leR_trans (\rsum_(a : A) \rsum_(b : B) Rabs ((`J(P, V)) (a, b) - (`J(P, W)) (a, b)))); last first.
