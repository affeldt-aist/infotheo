...
type ('id, 'u, 'd) tn_tree = { node_id : 'id; node_tag : tag; children : ('id, 'u, 'd) tn_tree list;
                               up : 'u; down : 'd }
...
let alpha_op out inp =
  let o,o' = out in
  let i,i' = inp in (rplus (rmult o i) (rmult o' i')),(rplus (rmult o i') (rmult o' i))
...
let rec sumprod_up k n =
  ...
  { node_id = n.node_id; node_tag = n.node_tag; children = children'; up = up'; down = () }
...
(** val sumprod_down : kind -> ('a1, r2, unit) tn_tree -> r2 option -> ('a1, r2, r2) tn_tree **)
...
let rec sumprod_down k n from_above =
  ...
  let funs = map (fun n' l -> sumprod_down (negk k) n' (Some (alpha_beta k n.node_tag l))) n.children
  in
  let children' = apply_seq funs args in
  { node_id = n.node_id; node_tag = n.node_tag; children = children'; up = n.up; down = down' }
