...
Require Import entropy channel.
...
Lemma WcPr : forall a b, P a != 0 -> W a b = cPr QP [set b] [set a].
Proof.
move=> a b Pa0.
...
Lemma mut_info_chanE : `I(P, W) = MutualInfo.mi QP.
Proof.
rewrite /MutualInfoChan.mut_info MutualInfo.miE2 -cond_entropy_chanE.
